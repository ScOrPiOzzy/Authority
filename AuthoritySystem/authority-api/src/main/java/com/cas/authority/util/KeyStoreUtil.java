...
public class KeyStoreUtil {
	...
	private static KeyStore getKeyStore(String keyStorePath, String passwd) throws Exception {
		return getKeyStore(new FileInputStream(keyStorePath), passwd);
	}

	private static KeyStore getKeyStore(InputStream ins, String passwd) throws Exception {
		KeyStore ks = KeyStore.getInstance(KEY_STORE);
		ks.load(ins, passwd.toCharArray());
		ins.close();
		return ks;
	}
	...
	public static PublicKey getPublicKey(String certificatePath) throws Exception {
		...
		try {
			certificate = getCertificate(KeyStoreUtil.class.getClassLoader().getResourceAsStream(certificatePath));
		} catch (Exception e) {
